    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="text-center mb-12">
          <motion.span
            {...fadeUp(0)}
            className="inline-block text-[13px] tracking-[0.2em] uppercase mb-4 font-bold text-lime-400"
          >
            Galeri
          </motion.span>
          <motion.h2
        ...
        <motion.div {...fadeUp(0.3)} className="text-center">
          <Link
            href="/galeri"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-full text-[14px] font-semibold no-underline transition-all duration-300 hover:bg-lime-400 hover:text-[var(--color-maroon-900)]"
