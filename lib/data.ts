...
export const activities: Activity[] = [
  {
    ...
    location: "Auditorium Utama, Universitas Brawijaya",
    ...
    agenda: [
      ...
      { time: "09:30 – 11:30", item: "Lomba Kaligrafi Live — Babak Penyisihan" },
      { time: "11:30 – 13:00", item: "Ishoma & Pameran Seni Interaktif" },
      { time: "13:00 – 15:30", item: "Penampilan Nasyid Grup & Tilawah" },
      { time: "15:30 – 16:00", item: "Shalat Ashar Berjamaah" },
      { time: "16:00 – 17:00", item: "Pengumuman Pemenang & Penutupan" },
    ],
  },
  {
    id: "evt-2",
    type: "event",
    title: "Workshop Kaligrafi Tingkat Lanjut",
    description: "Pelatihan intensif teknik kaligrafi gaya Tsuluts dan Diwani bersama seniman kaligrafi nasional selama dua hari penuh.",
    date: "5 Mei 2026",
    image: IMAGES.calligraphy,
    category: "Workshop",
    status: "upcoming",
    time: "09:00 – 16:00 WIB",
    location: "Ruang Seni Lt. 3, Gedung Kreativitas",
    ...
    agenda: [
      ...
      { time: "11:00 – 12:30", item: "Praktik Dasar Goresan Tsuluts" },
      { time: "13:30 – 15:00", item: "Pengenalan & Teknik Khat Diwani" },
      { time: "15:00 – 16:00", item: "Praktik Mandiri & Evaluasi Hari Pertama" },
    ],
  },
  {
    id: "evt-3",
    type: "event",
    title: "Lomba Nasyid Antar-Fakultas",
    description: "Kompetisi nasyid dengan 12 tim peserta dari berbagai fakultas memperebutkan piala bergilir Rektor.",
    date: "10 Maret 2026",
    image: IMAGES.stage,
    category: "Lomba",
    status: "completed",
    ...
    agenda: [
      ...
      { time: "15:30 – 16:00", item: "Shalat Ashar & Rehat" },
      { time: "16:00 – 18:30", item: "Penampilan Tim 7 s/d 12 — Babak Pertama" },
      { time: "18:30 – 19:15", item: "Shalat Maghrib & Ishoma" },
      { time: "19:15 – 19:45", item: "Penampilan Finalis (Top 3)" },
      { time: "19:45 – 20:00", item: "Penilaian Juri & Pengumuman Pemenang" },
    ],
  },
  {
    id: "evt-4",
    type: "event",
    title: "Latihan Rutin Tilawah Mingguan",
    description: "Pembinaan tilawah bersama ustadz pembimbing setiap Sabtu pagi untuk semua tingkat kemampuan.",
    date: "Setiap Sabtu",
    image: IMAGES.quran,
    category: "Rutin",
    status: "ongoing",
    ...
    agenda: [
      ...
      { time: "09:00 – 09:45", item: "Praktik Maqam & Latihan Individu" },
      { time: "09:45 – 10:00", item: "Evaluasi & Penutup" },
    ],
  },
  {
    id: "evt-5",
    type: "event",
    title: "Workshop Puisi Religi & Storytelling",
    description: "Belajar menulis puisi religi yang menyentuh hati dan teknik storytelling yang efektif bersama penulis ternama.",
    date: "15 Maret 2026",
    image: IMAGES.writing,
    category: "Workshop",
    status: "completed",
    time: "09:00 – 15:00 WIB",
    location: "Perpustakaan Lantai 2, Kampus Utama",
    ...
    agenda: [
      ...
      { time: "11:00 – 12:00", item: "Praktik Menulis Puisi Terpandu" },
      { time: "13:00 – 14:30", item: "Materi: Seni Storytelling Islami — Ridwan Kamali" },
      { time: "14:30 – 15:00", item: "Presentasi Karya & Penutupan" },
    ],
  },
  {
    id: "evt-6",
    type: "event",
    title: "Lomba Kaligrafi Digital Se-Jawa",
    description: "Kompetisi kaligrafi digital pertama yang diadakan secara hybrid, terbuka untuk seluruh mahasiswa se-Jawa.",
    date: "1 Juni 2026",
    image: IMAGES.art,
    category: "Lomba",
    status: "upcoming",
    time: "09:00 – 17:00 WIB",
    location: "Online & Gedung Kreatif, Lt. 2",
    ...
    agenda: [
      ...
      { time: "13:00 – 15:00", item: "Penilaian Juri & Seleksi Finalis" },
      { time: "15:30 – 16:30", item: "Presentasi Karya Finalis (Live di Gedung Kreatif)" },
      { time: "16:30 – 17:00", item: "Pengumuman Pemenang & Penyerahan Hadiah" },
    ],
  },
  {
    id: "art-1",
    type: "article",
    title: "UKM Seni Religi Raih Juara 1 Festival Nasyid Nasional 2026",
    description: "Tim nasyid berhasil mengalahkan 24 tim dari seluruh Indonesia dalam ajang bergengsi di Jakarta. Simak perjalanan mereka.",
    date: "12 Maret 2026",
    image: IMAGES.sunset,
    category: "Prestasi",
    readTime: "5 menit",
    tags: ["Nasyid", "Juara Nasional", "Prestasi", "Jakarta"],
  ...
  },
  {
    id: "art-2",
    type: "article",
    title: "Pendaftaran Anggota Baru Periode 2026/2027 Resmi Dibuka",
    description: "Pendaftaran terbuka untuk seluruh mahasiswa aktif. Pelajari syarat, alur pendaftaran, dan benefit menjadi anggota UKM.",
    date: "1 Maret 2026",
    image: IMAGES.ornament,
    category: "Pengumuman",
    readTime: "3 menit",
    tags: ["Pendaftaran", "Anggota Baru", "2026/2027", "Rekrutmen"],
    author: { name: "Hana Putri", role: "Kepala Humas UKM SR" },
    body: [
      "UKM Seni Religi Universitas Brawijaya dengan bangga mengumumkan pembukaan pendaftaran anggota baru untuk periode kepengurusan 2026/2027. Pendaftaran resmi dibuka mulai 1 Maret 2026 dan akan ditutup pada 31 Maret 2026.",
      "Siapa saja yang dapat mendaftar? Seluruh mahasiswa aktif UB dari angkatan 2023 hingga 2025, dari semua fakultas dan program studi. Tidak ada persyaratan kemampuan khusus — UKM SR menerima anggota dari semua latar belakang, baik yang sudah berpengalaman di bidang seni maupun yang baru ingin belajar.",
      "Proses pendaftaran sangat mudah: isi formulir online di website resmi UKM SR, lampirkan foto diri dan KTM, serta pilih divisi yang diminati (Kaligrafi, Nasyid, Tilawah, Puisi & Sastra, atau Humas). Setelah itu, calon anggota akan mengikuti seleksi administrasi dan wawancara singkat pada 5–10 April 2026.",
      "Bergabung dengan UKM SR bukan hanya soal mengembangkan bakat seni. Anda akan mendapatkan jaringan pertemanan yang luas, mentorship dari senior berpengalaman, kesempatan tampil di berbagai acara bergengsi, dan pengalaman berorganisasi yang akan sangat berharga dalam karier Anda ke depan.",
    ],
  },
  {
    id: "art-3",
    type: "article",
    title: "Kisah Inspiratif: Dari Pemula Kaligrafi Hingga Juara Nasional",
  ...
  },
  {
    id: "art-4",
    type: "article",
    title: "Kolaborasi Seni Religi dengan 5 Universitas di Indonesia",
  ...
  },
  {
    id: "art-5",
    type: "article",
    title: "Mengenal Lebih Dekat Divisi Tilawah: Tradisi & Inovasi",
    description: "Divisi Tilawah menggabungkan metode pembelajaran klasik dengan teknologi modern untuk menghasilkan qari dan qariah terbaik.",
    date: "5 Februari 2026",
    image: IMAGES.mosque,
    category: "Liputan",
    readTime: "6 menit",
    tags: ["Tilawah", "Divisi", "Al-Quran", "Profil"],
    author: { name: "Siti Rahma", role: "Jurnalis Media UKM SR" },
    body: [
  ...
  },
  {
    id: "art-6",
    type: "article",
    title: "Jadwal Kegiatan Ramadhan 1447 H: Rangkaian Acara Spesial",
    description: "Selama bulan Ramadhan, UKM menyiapkan serangkaian kegiatan mulai dari sahur bersama, kajian seni, hingga lomba tilawah.",
    date: "28 Januari 2026",
    image: IMAGES.courtyard,
    category: "Pengumuman",
    readTime: "3 menit",
    tags: ["Ramadhan", "Jadwal", "Kegiatan Spesial", "1447H"],
    author: { name: "Hana Putri", role: "Kepala Humas UKM SR" },
    body: [
      "Bulan Ramadhan 1447 H (Maret 2026) menjadi momen istimewa bagi UKM Seni Religi untuk menghadirkan rangkaian kegiatan yang mempererat ukhuwah sekaligus meningkatkan kualitas spiritual seluruh anggota. Berikut jadwal lengkap kegiatan Ramadhan UKM SR.",
      "Pekan pertama Ramadhan (1–7 Ramadhan): Kajian Seni Islami setiap Senin dan Kamis pukul 20.00 WIB di Mushola Kampus, membahas nilai-nilai estetika dalam Al-Quran dan Hadis. Selain itu, program Sahur Bersama & Qiyamullail diadakan pada 3 Ramadhan untuk seluruh anggota yang bisa hadir.",
...
export const DEPT_DATA: Record<string, DeptDetail> = {
  bkrt: {
    ...
    programDescriptions: [
      ...
      "Pendataan, perawatan, dan pengelolaan seluruh aset dan perlengkapan UKM secara sistematis untuk menjamin ketersediaan fasilitas operasional.",
      "Administrasi surat-menyurat, pengarsipan dokumen penting, dan penataan ruang sekretariat sebagai pusat operasional UKM.",
      "Memfasilitasi komunikasi dan sinergi lintas departemen dalam perencanaan dan pelaksanaan kegiatan bersama UKM.",
    ],
  ...
  psdm: {
    ...
    programDescriptions: [
      ...
      "Diklat kepemimpinan intensif untuk membentuk kader yang berkarakter, berintegritas, dan siap memimpin dalam berbagai konteks.",
      "Serangkaian pelatihan teknis dan non-teknis berkala yang dirancang meningkatkan kompetensi dan kualitas seluruh anggota UKM.",
      "Sistem pendampingan terstruktur antara anggota senior dan junior untuk percepatan tumbuh-kembang potensi dan softskill anggota.",
    ],
  ...
  minba: {
    ...
    programDescriptions: [
      ...
      "Penyelenggaraan lomba kaligrafi dengan berbagai kategori dan tingkatan untuk mendorong perkembangan bakat kaligrafi anggota UKM.",
      "Penampilan musik nasyid dalam berbagai event kampus dan eksternal sebagai representasi ekspresi seni religi UKM kepada publik.",
      "Pameran dan pertunjukan seni religi tahunan yang menjadi ajang bergengsi menampilkan seluruh cabang seni UKM kepada sivitas akademika.",
    ],
  ...
  medkom: {
    ...
    programDescriptions: [
      ...
      "Peliputan foto dan video seluruh kegiatan UKM secara profesional untuk keperluan arsip, publikasi, dan kenangan bersama.",
      "Pembuatan konten informatif dan menghibur bernafas religi yang menarik dan relevan bagi audiens mahasiswa di ruang digital.",
      "Pengembangan identitas visual UKM yang konsisten melalui desain materi promosi, banner, merchandise, dan aset digital lainnya.",
    ],
  ...
  humas: {
    ...
    programDescriptions: [
      ...
      "Kampanye pengenalan UKM kepada mahasiswa baru melalui berbagai kanal untuk merekrut calon anggota yang potensial dan bersemangat.",
      "Membangun jaringan alumni yang solid melalui program reunifikasi, database, dan kolaborasi untuk memperkuat ekosistem UKM.",
      "Menyebarluaskan informasi kegiatan dan prestasi UKM ke media massa, kampus lain, dan platform publik untuk meningkatkan visibilitas.",
    ],
...
export const galleryImages: GalleryItem[] = [
  ...
  { src: IMAGES.community, alt: "Komunitas UKM", caption: "Komunitas UKM" },
  { src: IMAGES.art, alt: "Karya Kaligrafi", caption: "Karya Kaligrafi" },
  { src: IMAGES.quran, alt: "Tilawah Al-Quran", caption: "Tilawah Al-Quran" },
...
export type AchievementCategory = "Kompetisi" | "Penghargaan" | "Kolaborasi" | "Rekam Jejak";
export type AchievementLevel = "Kampus" | "Kota" | "Provinsi" | "Nasional" | "Internasional";
...
export interface Achievement {
  ...
  position?: string;       // "Juara 1", "Juara 2", "Juara 3", "Finalis", dll.
  organizer: string;
  location: string;
...
export const achievements: Achievement[] = [
  ...
  {
    id: "ach-2026-01",
    title: "Juara 1 Festival Nasyid Nasional 2026",
    description: "Tim Nasyid UKM SR mengalahkan 24 tim perguruan tinggi dari seluruh Indonesia dengan aransemen orisinal 'Cahaya di Ujung Senja' di Balai Sarbini, Jakarta.",
    year: 2026,
    category: "Kompetisi",
    level: "Nasional",
    position: "Juara 1",
  ...
  {
    id: "ach-2026-02",
    title: "Juara 2 Lomba Kaligrafi MTQ Mahasiswa Tingkat Provinsi",
    description: "Ahmad Fauzi meraih posisi runner-up dalam cabang kaligrafi gaya Tsuluts pada MTQ Mahasiswa Jawa Timur, bersaing dengan 48 peserta dari 15 universitas.",
    year: 2026,
    category: "Kompetisi",
    level: "Provinsi",
    position: "Juara 2",
  ...
  {
    id: "ach-2026-03",
    title: "Penampil Terbaik MTQ Regional Malang Raya",
    description: "Divisi Tilawah UKM SR dinobatkan sebagai penampil terbaik kategori tilawah mahasiswa pada MTQ tingkat Regional Malang Raya.",
    year: 2026,
    category: "Penghargaan",
    level: "Kota",
    position: "Penampil Terbaik",
    organizer: "Pemkot Malang",
    location: "Malang, Jawa Timur",
  },
  {
    id: "ach-2026-04",
    title: "MoU Kolaborasi Seni Religi 5 Universitas Indonesia",
    description: "UKM SR menginisiasi dan menandatangani perjanjian kerja sama dengan 5 universitas dari Jawa, Sumatera, dan Kalimantan dalam program Jalinan Seni Nusantara.",
    year: 2026,
    category: "Kolaborasi",
    level: "Nasional",
    organizer: "UKM Seni Religi UB",
  ...
  {
    id: "ach-2025-01",
    title: "Juara 1 Kompetisi Nasyid Mahasiswa Nasional 2025",
    description: "Kemenangan nasional kedua berturut-turut dalam dua tahun terakhir, mengalahkan 31 tim dengan tema 'Damai dalam Keberagaman'.",
    year: 2025,
    category: "Kompetisi",
    level: "Nasional",
    position: "Juara 1",
  ...
  {
    id: "ach-2025-02",
    title: "Juara 3 Tilawah MTQ Mahasiswa Nasional",
    description: "Nurul Hidayah membawa UKM SR ke podium ketiga pada cabang tilawah MTQ Mahasiswa Nasional, bersaing dengan qari dan qariah terbaik dari seluruh Indonesia.",
    year: 2025,
    category: "Kompetisi",
    level: "Nasional",
    position: "Juara 3",
  ...
  {
    id: "ach-2025-03",
    title: "Juara 1 Lomba Kaligrafi Se-Jawa",
    description: "Tim kaligrafi UKM SR meraih juara pertama dalam lomba kaligrafi klasik tingkat se-Pulau Jawa, mengalahkan 67 peserta.",
    year: 2025,
    category: "Kompetisi",
    level: "Nasional",
    position: "Juara 1",
  ...
  {
    id: "ach-2025-04",
    title: "UKM Berprestasi Terbaik Universitas Brawijaya 2025",
    description: "UKM Seni Religi dinobatkan sebagai UKM Berprestasi terbaik oleh Rektorat UB atas capaian kompetisi dan inovasi program kerja sepanjang 2025.",
    year: 2025,
    category: "Penghargaan",
    level: "Kampus",
    position: "UKM Terbaik",
  ...
  {
    id: "ach-2025-05",
    title: "Hibah Program Kreativitas Mahasiswa Rp 75 Juta",
    description: "Proposal PKM-PM UKM SR berhasil lolos seleksi dan mendapatkan pendanaan hibah Rp 75 juta dari Kemdikbud untuk program pemberdayaan seni religi di pesantren.",
    year: 2025,
    category: "Penghargaan",
    level: "Nasional",
  ...
  {
    id: "ach-2024-01",
    title: "Juara 2 Festival Nasyid Mahasiswa Nasional 2024",
    description: "Tim Nasyid UKM SR tampil apik di peringkat kedua pada festival nasyid mahasiswa tingkat nasional yang digelar di Bandung.",
    year: 2024,
    category: "Kompetisi",
    level: "Nasional",
    position: "Juara 2",
  ...
  {
    id: "ach-2024-02",
    title: "Juara 1 Kaligrafi MTQ Mahasiswa Jawa Timur",
    description: "Ahmad Fauzi kembali meraih emas dalam kompetisi kaligrafi tingkat provinsi, memperkuat reputasi divisi kaligrafi UKM SR di Jawa Timur.",
    year: 2024,
    category: "Kompetisi",
    level: "Provinsi",
    position: "Juara 1",
  ...
  {
    id: "ach-2024-03",
    title: "Penampil Terbaik Festival Seni Islam Nasional",
    description: "Divisi Puisi & Sastra UKM SR dinobatkan sebagai penampil terbaik atas penampilan puisi religi bertema 'Cahaya Ramadhan' pada festival yang diikuti 40 universitas.",
    year: 2024,
    category: "Penghargaan",
    level: "Nasional",
    position: "Penampil Terbaik",
  ...
  {
    id: "ach-2024-04",
    title: "Kolaborasi Produksi Album Nasyid dengan Label Nasional",
    description: "UKM SR berkolaborasi dengan label musik islami nasional dalam produksi EP (Extended Play) 4 lagu — momen bersejarah pertama bagi UKM mahasiswa di Jawa Timur.",
    year: 2024,
    category: "Kolaborasi",
    level: "Nasional",
  ...
  {
    id: "ach-2023-01",
    title: "Juara 1 Tilawah Antar-Kampus Se-Malang Raya",
    description: "Nurul Hidayah meraih juara pertama cabang tilawah putri, mengalahkan 22 peserta dari 8 universitas di area Malang Raya.",
    year: 2023,
    category: "Kompetisi",
    level: "Kota",
    position: "Juara 1",
    organizer: "BEM Universitas Brawijaya",
    location: "Malang, Jawa Timur",
  },
  {
    id: "ach-2023-02",
    title: "Juara 3 Kompetisi Nasyid Mahasiswa Nasional 2023",
    description: "Tim Nasyid merebut posisi ketiga di tingkat nasional — awal kebangkitan yang mendorong performa lebih baik pada 2024 dan 2025.",
    year: 2023,
    category: "Kompetisi",
    level: "Nasional",
    position: "Juara 3",
  ...
  {
    id: "ach-2023-03",
    title: "Kolaborasi Live Performance dengan TVRI Jawa Timur",
    description: "Tim Nasyid dan Kaligrafi tampil dalam program siaran langsung TVRI Jawa Timur pada peringatan Hari Santri Nasional 2023, menjangkau jutaan pemirsa.",
    year: 2023,
    category: "Kolaborasi",
    level: "Provinsi",
    organizer: "TVRI Jawa Timur",
    location: "Studio TVRI Surabaya",
  },
  {
    id: "ach-2023-04",
    title: "500+ Anggota Aktif — Rekor Tertinggi Sepanjang Sejarah",
    description: "Pada periode 2023/2024, UKM SR mencapai jumlah anggota aktif terbanyak dalam sejarah organisasi dengan lebih dari 500 mahasiswa terdaftar dari 15 fakultas.",
    year: 2023,
  ...
  {
    id: "ach-2022-01",
    title: "UKM Terbaik Universitas Brawijaya 2022",
    description: "UKM SR meraih penghargaan UKM Terbaik dari Rektorat UB atas prestasi kompetisi, program inovatif, dan kontribusi terhadap nama baik universitas.",
    year: 2022,
    category: "Penghargaan",
    level: "Kampus",
    position: "UKM Terbaik",
  ...
  {
    id: "ach-2022-02",
    title: "Juara 1 Lomba Puisi Religi Tingkat Provinsi Jawa Timur",
    description: "Divisi Puisi & Sastra berhasil meraih juara pertama dalam kompetisi puisi religi tingkat provinsi yang diikuti mahasiswa dari 20 perguruan tinggi se-Jawa Timur.",
    year: 2022,
    category: "Kompetisi",
    level: "Provinsi",
    position: "Juara 1",
    organizer: "Dinas Kebudayaan Jawa Timur",
    location: "Surabaya, Jawa Timur",
  },
  {
    id: "ach-2022-03",
    title: "Juara 2 Kaligrafi MTQ Mahasiswa Regional Jawa-Bali",
    description: "Tim kaligrafi meraih runner-up dalam kompetisi bergengsi tingkat Regional Jawa-Bali yang mencakup 11 provinsi.",
    year: 2022,
    category: "Kompetisi",
    level: "Nasional",
    position: "Juara 2",
    organizer: "LPTQ Nasional – Zona Jawa-Bali",
    location: "Bali",
  },
  // ── 2021 ──────────────────────────────────────────────────────────────────
  {
    id: "ach-2021-01",
    title: "Juara 1 Festival Nasyid Virtual Nasional 2021",
    description: "Di tengah pandemi, tim nasyid mengikuti kompetisi virtual nasional dan meraih juara pertama — membuktikan semangat yang tidak padam meski di situasi sulit.",
    year: 2021,
    category: "Kompetisi",
    level: "Nasional",
    position: "Juara 1",
    organizer: "Kementerian Agama RI (Daring)",
    location: "Online — Jakarta",
  },
  {
    id: "ach-2021-02",
    title: "Penampil di Peringatan Maulid Nabi Istana Negara",
    description: "Tim Tilawah dan Nasyid UKM SR mendapat kehormatan tampil dalam acara kenegaraan Peringatan Maulid Nabi Muhammad SAW di Istana Negara Jakarta — pencapaian tertinggi sepanjang sejarah UKM.",
    year: 2021,
    category: "Penghargaan",
    level: "Nasional",
    position: "Penampil Istana Negara",
  ...
  {
    id: "ach-2021-03",
    title: "Penghargaan Inovasi Seni Religi Mahasiswa dari Kemdikbud",
    description: "Program inovasi tilawah digital UKM SR mendapat pengakuan resmi dari Kemdikbudristek sebagai program seni berbasis teknologi terbaik kategori mahasiswa.",
    year: 2021,
    category: "Penghargaan",
    level: "Nasional",
    organizer: "Kemdikbudristek RI",
  ...
  {
    id: "ach-2020-01",
    title: "Juara 1 Nasyid Regional Jawa 2020",
    description: "Tim nasyid meraih posisi teratas pada kompetisi regional Jawa yang mencakup DKI Jakarta, Jawa Barat, Jawa Tengah, dan Jawa Timur.",
    year: 2020,
    category: "Kompetisi",
    level: "Nasional",
    position: "Juara 1",
    organizer: "Forum Nasyid Indonesia – Region Jawa",
    location: "Yogyakarta",
  },
  {
    id: "ach-2020-02",
    title: "Rekam Jejak 100+ Alumni Berprestasi Nasional",
    description: "Sejak berdiri pada 2015, lebih dari 100 alumni UKM SR telah meraih prestasi tingkat nasional di bidang seni religi — kaligrafi, nasyid, tilawah, dan sastra.",
    year: 2020,
    category: "Rekam Jejak",
    level: "Nasional",
    organizer: "UKM Seni Religi UB",
